...
// Init is a paid mutator transaction binding the contract method 0xf8f5faa2.
//
// Solidity: function init(string name, string symbol, uint8 decimals, uint256 totalSupply) returns()
func (_Token *TokenTransactor) Init(opts *bind.TransactOpts, name string, symbol string, decimals uint8, totalSupply *big.Int) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "init", name, symbol, decimals, totalSupply)
}

// Init is a paid mutator transaction binding the contract method 0xf8f5faa2.
//
// Solidity: function init(string name, string symbol, uint8 decimals, uint256 totalSupply) returns()
func (_Token *TokenSession) Init(name string, symbol string, decimals uint8, totalSupply *big.Int) (*types.Transaction, error) {
	return _Token.Contract.Init(&_Token.TransactOpts, name, symbol, decimals, totalSupply)
}

// Init is a paid mutator transaction binding the contract method 0xf8f5faa2.
//
// Solidity: function init(string name, string symbol, uint8 decimals, uint256 totalSupply) returns()
func (_Token *TokenTransactorSession) Init(name string, symbol string, decimals uint8, totalSupply *big.Int) (*types.Transaction, error) {
	return _Token.Contract.Init(&_Token.TransactOpts, name, symbol, decimals, totalSupply)
}
